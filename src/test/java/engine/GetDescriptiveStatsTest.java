...
public class GetDescriptiveStatsTest {
	...
	@Test
	public void test() {
		assertEquals(request1, controller.getDescriptiveStats("GR-TOT"));
	}
	
	@Test
	public void rainyDayTest() {
		assertEquals(null, controller.getDescriptiveStats("WRONG-REQ"));
	}
}
